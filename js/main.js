...
const apiKey = '2834c515e308ffe7119cce329be401ed';
const apiSecret = '6556054a80f423c2db18d056480fb4d9';
...
function fetchAnimals(e) {
  ...
  // Fetch Pets
  fetchJsonp(
    `http://api.petfinder.com/pet.find?format=json&key=${apiKey}&animal=${animal}&location=${zip}&callback=callback`,
    {
